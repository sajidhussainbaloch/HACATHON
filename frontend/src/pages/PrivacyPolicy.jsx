      ...
      <div className="rounded-2xl p-8 shadow-lg"
        ...
        <div className="space-y-6 text-sm leading-relaxed" style={{ color: 'var(--text-secondary)' }}>
          ...
          <section>
            ...
            <p>When you use Reality Check AI Plus, we may collect the following information:</p>
          ...
          <section>
            ...
            <ul className="list-disc ml-6 space-y-1">
              <li>To provide and maintain the Reality Check AI Plus service</li>
          ...
          <section>
            ...
            <p>Reality Check AI Plus uses the following third-party services to operate:</p>
            <ul className="list-disc ml-6 mt-2 space-y-1">
          ...
          <section>
            ...
            <p>
              Reality Check AI Plus uses browser local storage to maintain your authentication session (JWT token)
